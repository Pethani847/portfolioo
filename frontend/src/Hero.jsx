      ...
      <section className="px-10 lg:px-20 py-4">
        ...
        >
          <div className="flex items-center lg:items-start text-center lg:text-start flex-col w-full">
            ...
            <div className="flex flex-row justify-center  flex-wrap gap-4 lg:gap-8 text-xl lg:text-3xl mb-4 lg:mb-8">
            ...
            <div className="flex flex-wrap justify-center items-start gap-4 lg:gap-6 text-xl lg:text-4xl mb-8 lg:mb-10 font-medium text-pyellow">
