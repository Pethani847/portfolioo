    ...
    return (  
        ...
        <section className="px-10 lg:px-20 py-4 ">
            <main className='flex flex-col justify-center items-center lg:items-start min-h-screen' id='education'>
              ...
              <p className="text-base lg:text-xl font-medium">03 | EDUCATION</p>
              ...
              <div className='flex flex-col items-center text-center lg:text-start lg:items-start w-full'>
                <h1 className="text-3xl lg:text-5xl mb-2 font-bold tracking-wide">What I learned & What's next.</h1>
                <p className="text-sm lg:text-xl italic font-light mb-10 lg:mb-15 ">// academic background & upcoming plan</p>
                ...
                <p className='text-sm lg:text-xl italic font-light'>-------Scrolll!</p>
              </div>
            </main>
        </section>
        </>
