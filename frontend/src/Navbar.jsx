...
function Navbar() {
  ...
  return (
    <>
      <nav className="flex justify-between items-center bg-bg w-full px-8 h-10 lg:h-16 sticky top-0 z-50 border-b">
        ...
        <div className="flex mr-3 lg:mr-5">
          <div className="flex max-md:hidden">
            {[
              ...
              >
                {item}
                <span className="absolute left-0 -bottom-0.5 h-0.5 w-0 bg-pyellow transition-all duration-300 group-hover:w-full"></span>
              </a>
            ))}
          </div>
          </div>
          ...
          >
            <div className="flex flex-col items-center gap-6 text-lg">
              {[
                ...
                >
                  {item}
                  <span className="absolute left-0 -bottom-0.5 h-0.5 w-0 bg-pyellow transition-all duration-400 group-hover:w-full"></span>
                </a>
              ))}
            </div>
          </div>
